...
public class HealthPickup : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (pickupVisual == null)
        {
            ...
            {
                Debug.LogWarning($"HealthPickup on {gameObject.name}: No pickup visual assigned. Assign a child GameObject for the visual representation.");
            }
        }
    }
    ...
    private void Start()
    {
        ...
        {
            Debug.LogError("HealthPickup: No Player found in scene!");
        }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (isAvailable)
        {
            ...
            if (playerComponent != null)
            {
                ...
                if (playerComponent.GetCurrentHealth() < playerComponent.GetMaxHealth())
                {
                    // Heal player
